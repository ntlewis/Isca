...
class Experiment(Logger, EventEmitter):
    ...
    @destructive
    @useworkdir
    def run(self, i, restart_file=None, use_restart=True, multi_node=False, num_cores=8, overwrite_data=False, save_run=False, run_idb=False, nice_score=0, mpi_runopts=''):
        """Run the model.
