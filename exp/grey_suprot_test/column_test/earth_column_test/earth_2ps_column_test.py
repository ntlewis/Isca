...
exp = Experiment('venus_grey_test_column', codebase=cb)
...
T_ini = 600.
grav = 8.87
tau_lw_s = 0.97 * 250 #(corresponds to 50,000 at surface) #473.56
tau_sw_s = .5#0.22 * tau_lw_s #0.22 is anti-greenhouse parameter 
solar_constant = 2613.9 
albedo = 0.76
omega = 2.99e-7
radius = 6.052e6
R_d = 188.
...
exp.namelist = namelist = Namelist({
    ...
    'two_stream_scatter_rad_nml': {
        ...
        'lw_abs_b': 0.0, 
        'lw_abs_c': 0.0, 
        'lw_abs_d': tau_lw_s, #grav * tau_lw_s / ps, 
        'lw_abs_f': lw_f, 
        'lw_abs_pref': pr, 
        'lw_sca_a':0.0,
        'lw_sca_b':0.0,
        'sw_abs_a': grav * tau_sw_s / ps, 
        'sw_abs_b':0.0, 
        'sw_sca_a':0.0, 
        'sw_sca_b':0.0,
        'g_asym' : 0.0, 
