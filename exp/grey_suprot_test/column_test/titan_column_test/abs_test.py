...
exp = Experiment('earth_col_mlevs_notaurcsplit_abs', codebase=cb)
...
ps = 100000
grav = 9.81
omega = 7.29-5#4.56e-6
radius = 6.371e6#2.576e6
R_d = 287.
cp = 1005.
...
dt_conv = 7200. #* 2. # slow timescale for dry convection 
gamma_conv = 0.7
...
# robinson set 
tau_zero                = 1.#2.#2. #4.324
pres_zero               = ps #(0.3)*ps #ps
do_rc_optical_depth     = False
tau_rc                  = -1#tau_zero/10.
pres_rc                 = -1#(31622./1.e5)*pres_zero
linear_tau              = 0.0#25
nonlin_tau_exponent     = 4./3.
sw_k1                   = 35.167 #51.8 #35.168 #0.0 #
...
sw_k1_frac              = 4./7. 
do_sw_split             = True 
solar_constant          = 1000.#1360.#3.6 * 4.
del_sol                 = 1.4 
del_sw                  = 0.0 
do_seasonal             = False 
solday                  = -10 
