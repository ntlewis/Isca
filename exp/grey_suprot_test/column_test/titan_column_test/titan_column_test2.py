...
exp = Experiment('titan_grey_test_column2', codebase=cb)
...
T_ini = 100.
grav = 8.87
tau_lw_s = 5 #was4 #(corresponds to 50,000 at surface) #473.56
tau_sw_s = 40.   #.5#0.22 * tau_lw_s #0.22 is anti-greenhouse parameter 
...
exp.namelist = namelist = Namelist({
    ...
    'two_stream_scatter_rad_nml': {
        ...
        'lw_abs_a': grav * tau_lw_s / ps, 
        'lw_abs_b': 0.0, 
        'lw_abs_c': 0.0, 
        'lw_abs_d': 0.0, #grav * tau_lw_s / ps, 
        'lw_abs_f': lw_f, 
        'lw_abs_pref': pr, 
        'lw_sca_a':0.0,
        'lw_sca_b':0.0,
