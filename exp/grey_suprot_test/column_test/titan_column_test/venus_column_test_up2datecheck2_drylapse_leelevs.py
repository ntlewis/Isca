...
exp = Experiment('venus_col_logcheck_finalFlux_52H145_leelevs_cp900', codebase=cb)
...
# rt parameters 
var_cp = True#True#False 
# # mckay set 
tau_zero                = 725.#1100#5.#4.54#4.47 
pres_zero               = ps##150000
...
exp.namelist = namelist = Namelist({
    ...
    'column_nml': {
        ...
        'lat_max': 1, # number of columns in latitude, precise 
                      # latitude can be set in column_grid_nml if only 1 lat used. 
        'num_levels': 30,  # number of levels 
        'initial_sphum': 0.0, 
