...
exp = Experiment('titan_col_log_check_newFlux_52H145_multicol', codebase=cb)
...
# rt parameters 
# # mckay set 
# tau_zero                = 5.#4.54#4.47 
# pres_zero               = 150000
# do_rc_optical_depth     = False 
# tau_rc                  = -1. 
# pres_rc                 = -1.
# linear_tau              = 0.0
# nonlin_tau_exponent     = 4./3.

# tau_zero                = 1./5./2.#77#.06#.#4.54#4.47 #next change the .9 to a .8
# pres_zero               = ps/5./2.**np.sqrt(2.)#.1*1e5
# do_rc_optical_depth     = False 
# tau_rc                  = -1. 
# pres_rc                 = -1.
# linear_tau              = 0.5#.85
# nonlin_tau_exponent     = 2.#4./3.
# lin_tau_exponent        = 3./4.#2./3.
...
solar_constant          = 3.6* 4. * (1-0.27)#1360. #
del_sol                 = 1.#4 
del_sw                  = 0.0 
do_seasonal             = False 
solday                  = -10 
...
exp.namelist = namelist = Namelist({
    ...
    'column_nml': {
        'lon_max': 1, # number of columns in longitude, default begins at lon=0.0
        'lat_max': 32, # number of columns in latitude, precise 
                      # latitude can be set in column_grid_nml if only 1 lat used. 
