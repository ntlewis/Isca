...
exp = Experiment('venus_col_log_check_expFlux_52H145', codebase=cb)
...
sw_k1                   = 903.88/2750.#275#0.0#141.22/4.#35.167 
...
# these don't change 
bond_albedo             = 0.0#27 
sw_k1_frac              = (1-30./150.)#4./7. #1.
do_sw_split             = True#False#True # False
