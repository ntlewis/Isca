...
expname = lambda om_fact:'VENUS_T21L60_NEWFLUX_HTSPONGE_VDIFF_2DRAG_DT720_NORES'
timestep  = 360.#60.#120
...
exp.inputfiles = [os.path.join(base_dir, 'create_ic/venus_col_log_check_newFlux_ic.nc')]
...
exp.namelist = namelist = Namelist({
    ...
    'ic_from_external_file_nml':{ 
        'file_name':'INPUT/venus_col_log_check_newFlux_ic.nc', 
        'u_name': 'ucomp', 
        'v_name': 'vcomp', 
        't_name': 'temp', 
        'ps_name': 'ps'
...
if __name__=="__main__":
    ...
    #run_exp.namelist['mixed_layer_nml']['neil_ic_file_name'] = 'INPUT/venus_col_log_check_newFlux_ic.nc'
    #run_exp.run(1, use_restart=False, num_cores=cores, overwrite_data=True)
    for i in range(46,1001):
