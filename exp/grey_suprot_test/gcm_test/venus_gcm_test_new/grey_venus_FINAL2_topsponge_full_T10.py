...
expname = lambda om_fact:'VENUS_T42L52_topsponge_full_testres75'
timestep  = 120.#60.#120
...
exp.inputfiles = [os.path.join(base_dir, 'create_ic/venus_col_log_check_newFlux_52H145_ic_T10.nc')]
...
exp.namelist = namelist = Namelist({
    ...
    'ic_from_external_file_nml':{ 
        'file_name':'INPUT/venus_col_log_check_newFlux_52H145_ic_T10.nc', 
        'u_name': 'ucomp', 
        'v_name': 'vcomp', 
        't_name': 'temp', 
        'ps_name': 'ps'
...
if __name__=="__main__":
    exp.run(1, use_restart=True, num_cores=cores, overwrite_data=False, 
           restart_file='/home/lewis/dir_for_venusres/res0075_T42.tar.gz')
    
#     run_exp = exp.derive(expname(1.))
#     run_exp.namelist['spectral_dynamics_nml']['initial_state_option'] = 'input'
#     #run_exp.namelist['mixed_layer_nml']['ic_neil_style'] = True 
#     #run_exp.namelist['mixed_layer_nml']['neil_ic_file_name'] = 'INPUT/venus_col_log_check_newFlux_52H145_ic_T10.nc'
#     ds = af.open_experiment('venus_col_log_check_newFlux_52H145',50,50,'atmos_monthly.nc',variables=['temp'],cal=False)
...
#     #                        'VENUS_T21L52_topsponge_full_reswithu_hyp10_diffresTs_dt180/restarts/res0020.tar.gz')
    
    for i in range(2,13):#001):#1001):
