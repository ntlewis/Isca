...
expname = lambda om_fact:'VENUS_T21L50_sfcalb'
timestep  = 120.#60.#120
...
if __name__=="__main__":
    exp.run(1, use_restart=True, num_cores=cores, overwrite_data=False, 
           restart_file='/network/group/aopp/planetary/PLR018_LEWIS_VENUS2/'+
                        'isca_data/VENUS_T21L50/restarts/res0100.tar.gz')
