...
expname = lambda om_fact:'VENUS_T21LLEB_cp900_weakerbl1em3_weakerdiff_varcp'
timestep  = 120.#60.#120
...
# BL params 
gust        = 0.5#0.0 
rough_mom   = 1.e-3#1.e-2
rough_moist = 1.e-3#1.e-2
rough_sens  = 1.e-3#1.e-2
...
exp.inputfiles = [os.path.join(base_dir, 'create_ic/venus_col_logcheck_finalFlux_52H145_leblevs_cp900_ic_T21.nc')]
...
exp.namelist = namelist = Namelist({
    ...
    'ic_from_external_file_nml':{ 
        'file_name':'INPUT/venus_col_logcheck_finalFlux_52H145_leblevs_cp900_ic_T21.nc', 
        'u_name': 'ucomp', 
        'v_name': 'vcomp', 
        't_name': 'temp', 
        'ps_name': 'ps'
