...
expname = lambda om_fact:'VENUS_T21LLEB_oldlapse_varcp'
timestep  = 120.#60.#120
...
exp.inputfiles = [os.path.join(base_dir, 'create_ic/venus_col_logcheck_finalFlux_52H145_leblevs_oldlapse_ic_T21.nc')]
...
exp.namelist = namelist = Namelist({
    ...
    'ic_from_external_file_nml':{ 
        'file_name':'INPUT/venus_col_logcheck_finalFlux_52H145_leblevs_oldlapse_ic_T21.nc', 
        'u_name': 'ucomp', 
        'v_name': 'vcomp', 
        't_name': 'temp', 
        'ps_name': 'ps'
...
if __name__=="__main__":
    ...
    ds = af.open_experiment('venus_col_logcheck_finalFlux_52H145_leblevs_oldlapse',3,3,'atmos_monthly.nc',
