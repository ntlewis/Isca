...
expname = lambda om_fact:'VENUS_T21L52_olddiff_highsponge_oldbl_diff3day_gust05_rcini_stneil'
timestep  = 120.#60.#120
...
rough_moist = 1.e-5
rough_sens  = 1.e-5
background_m = 0.01#1#5
background_t = 0.01#1#5
...
exp.inputfiles = [os.path.join(base_dir, 'create_ic/venus_col_log_check_newFlux_52H145_multi_ic_T21lattsurf.nc')]
#exp.inputfiles = [os.path.join(base_dir, 'create_ic/titan_col_log_check_newFlux_ic.nc')]

#Tell model how to write diagnostics
diag = DiagTable()
diag.add_file('atmos_monthly', 0.5, 'days', time_units='days')
...
exp.namelist = namelist = Namelist({
    ...
    'mixed_layer_nml': {
        ...
        'neil_ic_file_name':'INPUT/venus_col_log_check_newFlux_52H145_multi_ic_T21lattsurf.nc',
        't_surf_name':'t_surf',
    },
    ...
    'ic_from_external_file_nml':{ 
        'file_name':'INPUT/venus_col_log_check_newFlux_52H145_multi_ic_T21lattsurf.nc', 
        'u_name': 'ucomp', 
        'v_name': 'vcomp', 
        't_name': 'temp', 
        'ps_name': 'ps'
