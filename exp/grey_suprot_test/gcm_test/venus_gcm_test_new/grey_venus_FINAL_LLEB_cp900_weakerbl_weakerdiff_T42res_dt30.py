...
expname = lambda om_fact:'VENUS_T42LLEB_cp900_weakerbl_weakerdiff_res_dt30'
timestep  = 30.#60.#120
...
rough_moist = 1.e-4
rough_sens  = 1.e-4
background_m = 0.01#5#5
background_t = 0.01#5#5
...
exp.inputfiles = [os.path.join(base_dir, 'create_ic/venus_col_logcheck_finalFlux_52H145_leblevs_cp900_ic_T42.nc')]
...
exp.namelist = namelist = Namelist({
    ...
    'ic_from_external_file_nml':{ 
        'file_name':'INPUT/venus_col_logcheck_finalFlux_52H145_leblevs_cp900_ic_T42.nc', 
        'u_name': 'ucomp', 
        'v_name': 'vcomp', 
        't_name': 'temp', 
        'ps_name': 'ps'
...
if __name__=="__main__":
    ...
    #ds = af.open_experiment('venus_col_logcheck_finalFlux_52H145_leblevs_cp900',50,50,'atmos_monthly.nc',
    #                        variables=['temp'],cal=False)
    #T_ini_sfc = np.squeeze(ds.temp.values[-1,-1])
    #run_exp.namelist['mixed_layer_nml']['tconst'] = T_ini_sfc+1.
    run_exp.run(1, num_cores=cores, use_restart=True, overwrite_data=False,
                restart_file='/home/lewis/dir_for_venusres/res0890_T42.tar.gz')
