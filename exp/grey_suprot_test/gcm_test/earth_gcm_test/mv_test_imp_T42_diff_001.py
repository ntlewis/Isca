...
exp_name = 'mv_T42_L20_dt120_even_rad_1_8_imp_diff_001'
...
namelist = Namelist({
    ...
    'spectral_dynamics_nml': {
        'damping_order'           : 4,                      # default: 2 'damping_coeff': 1 / (1./5. * 86400.), #'eddy_sponge_coeff' : 1/(1./10. * 86400.),
    ...
    'vert_turb_driver_nml': {
        ...
        'use_tau': False, 
        'do_background_only':True, 
        'diff_m_background_only':0.01,#0.01, 
        'diff_t_background_only':0.01,#0.01,
    },
