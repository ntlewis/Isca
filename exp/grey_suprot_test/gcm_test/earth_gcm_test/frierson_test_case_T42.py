...
exp = Experiment('earth_gcm_test_frierson_gamma1_rad1_8_raisetop_rtop_0_T42L40_dt480_hdiff_1_10', codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'spectral_dynamics_nml': {
        'damping_order': 4,                   
        'damping_coeff': 1 / (1./10. * 86400.), #'eddy_sponge_coeff' : 1/(1./12. * 86400.),
        'water_correction_limit': 0.0,
        'reference_sea_level_press':1.0e5,
        'num_levels':40,#200,               #How many model pressure levels to use
        'valid_range_t':[100.,800.],
        'initial_sphum':[0.0],
        'vert_coord_option':'hybrid', #Use the vertical levels from Frierson 2006
        'robert_coeff':0.03,
        'lon_max': 128,
        'lat_max': 64,
        'num_fourier': 42,
    ...
    'damping_driver_nml': {
        'do_rayleigh': False,
        'trayfric': -(1./36.),              # neg. value: time in *days*
