...
exp = Experiment('grey_T42L50_rad2_1_om1_4_test_scatter_perp_eq_makenmlsame_exact2_wdefaults_consants', codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'ic_from_external_file_nml':{  # file for initial condition specified in experiment specific loop.
        ...
        't_name': 'temp', 
        'ps_name': 'ps', 
        'file_name':'INPUT/1bar_0frac_ic.nc'
    ...
    'constants_nml':{
        ...
        'radius'  : radiuse*2., # modified in experiment loop 
    },
    ...
    'mixed_layer_nml': {
        ...
        'neil_ic_file_name': 'INPUT/1bar_0frac_ic.nc'
    },
