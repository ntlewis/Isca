...
exp = Experiment('earth_gcm_test_small_abs', codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'damping_driver_nml': {
        ...
        'sponge_pbottom':  1.0 * (ps/1.5e5),           #Bottom of the model's sponge down to 50hPa (units are Pa)
