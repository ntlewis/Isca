...
exp = Experiment('frierson_T42_L40_dt360_r_1_8_pklevstruc_rayfricsfc_sponge', codebase=cb)
...
diag.add_field('dynamics', 'dt_vg_damp', time_avg=True)
...
exp.namelist = namelist = Namelist({
    ...
    'spectral_dynamics_nml': {
        'damping_order': 4,                   
        'damping_coeff': 1 / (1./2. * 86400.), #'eddy_sponge_coeff' : 1/(1./2. * 86400.),
        'water_correction_limit': 200.e2,
        'reference_sea_level_press':1.0e5,
        'num_levels':60,#200,               #How many model pressure levels to use
        'valid_range_t':[100.,800.],
        'initial_sphum':[0.0],
        'vert_coord_option':'hybrid',#'hybrid', #Use the vertical levels from Frierson 2006
        'robert_coeff':0.03,
        'lon_max': 128,
        'lat_max': 64,
        'num_fourier': 42,
    ...
    'damping_driver_nml': {
        'do_rayleigh': True,
        'trayfric': -(1./8.),              # neg. value: time in *days*
        'sponge_pbottom':  100.,           #Bottom of the model's sponge down to 50Pa (units are Pa)
