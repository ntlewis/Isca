...
exp_name = 'held_suarez_T42_L40_dt360_r_1_8_pklevstruc_sponge'
...
namelist = Namelist({
    ...
    'spectral_dynamics_nml': {
        ...
        'eddy_sponge_coeff' : 1/(1./12. * 86400.),
        ...
        'num_levels':40,#20,               #How many model pressure levels to use
        'scale_heights': 11.5,#6.0,
        'exponent': 5.0,#7.5,
        'surf_res': 0.5,#0.5
    },
    ...
    'hs_forcing_nml': {
        ...
        'ka':   -30.,#40.,      # Constant Newtonian cooling timescale (default 40 days)
        'ks':    -2.5,#4.,      # Boundary layer dependent cooling timescale (default 4 days)
        'kf':   -0.6,#1.,       # BL momentum frictional timescale (default 1 days)
