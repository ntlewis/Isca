...
exp = Experiment('earth_gcm_test_frierson_gamma1_rad1_8_raisetop_hybrid_rtop_50_dt600_T21L32_yrly', codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'spectral_dynamics_nml': {
        'damping_order': 4,                   
        'damping_coeff': 1 / (1./2. * 86400.), #'eddy_sponge_coeff' : 1/(1./10. * 86400.),
        'water_correction_limit': 0.0,
        'reference_sea_level_press':1.0e5,
        'num_levels':32,               #How many model pressure levels to use
