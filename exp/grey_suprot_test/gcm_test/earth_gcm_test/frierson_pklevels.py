...
exp = Experiment('frierson_T42_L40_dt360_r_1_8_frlevstruc', codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'spectral_dynamics_nml': {
        ...
        'num_levels':25,#40,#200,               #How many model pressure levels to use
        'valid_range_t':[100.,800.],
        'initial_sphum':[0.0],
        'vert_coord_option':'input',#'hybrid', #Use the vertical levels from Frierson 2006
        'robert_coeff':0.03,
        'lon_max': 128,
        'lat_max': 64,
        'num_fourier': 42,
