...
exp_name = 'mv_T31_L50_dt240_damp2_5_7h_LAPsponge_0_7h_12hr30day'
...
namelist = Namelist({
    ...
    'spectral_dynamics_nml': {
        ...
        'damping_coeff'           : 1. / (5.7 * 60. * 60.), #
        'eddy_sponge_coeff'       : 1. / (0.7 * 60. * 60.),
...
if __name__ == '__main__':
    ...
    restart_file='/network/group/aopp/planetary/PLR016_LEWIS_VENUS/isca_data/mv_T31_L50_dt240_damp2_5_7h_LAPsponge_0_7h/restarts/res0036.tar.gz')
    #for i in range(2, 85):
