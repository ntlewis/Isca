...
exp_name = 'mv_T31_L20_dt240_damp4old_24h_nosponge_12hr30day'
...
if __name__ == '__main__':
    ...
    restart_file='/network/group/aopp/planetary/PLR016_LEWIS_VENUS/isca_data/mv_T31_L20_dt240_even_rad_1_8_imp_damp_1_10/restarts/res0036.tar.gz')
    #for i in range(2, 37):
