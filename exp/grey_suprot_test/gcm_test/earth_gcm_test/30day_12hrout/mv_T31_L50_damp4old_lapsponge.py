...
exp_name = 'mv_T31_L50_dt240_damp4old_24h_LAPsponge_12h_12hr30day'
...
namelist = Namelist({
    ...
    'spectral_dynamics_nml': {
        ...
        'damping_coeff': 1 / (1./1. * 86400.), #
        'eddy_sponge_coeff' : 1/(1./2. * 86400.),
...
if __name__ == '__main__':
    exp.run(1, num_cores=NCORES, use_restart=True, overwrite_data=True, 
    restart_file='/network/group/aopp/planetary/PLR016_LEWIS_VENUS/isca_data/mv_T31_L50_dt240_mimastruc_rad_1_8_imp_damp_1_10_LAPsponge/restarts/res0036.tar.gz')
    #for i in range(2, 37):
