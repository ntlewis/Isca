...
expname = lambda om_fact:'TITAN_T21L60_NEWFLUX_HTSPONGE_VDIFF_2DRAG_DT720_RES'
timestep  = 720.#60.#120
...
if __name__=="__main__":
    ...
    run_exp.run(1, use_restart=False, num_cores=cores, overwrite_data=False)
