...
expname = lambda om_fact:'TITAN_T21L50_seasonal'
timestep  = 180.#60.#120
...
solday                  = -10 
equinox_day             = 0.0
dt_rad_avg              = -1 #SEASONSHACK
use_time_average_coszen = True #SEASONS
diabatic_acce           = 1.
...
diag = DiagTable()
diag.add_file('atmos_monthly', 933120000.0/360., 'seconds', time_units='seconds')
...
exp.namelist = namelist = Namelist({
    ...
    'constants_nml':{
        ...
        'orbital_period':orbital_period, # 30 years
        'earthday_multiple':earthday_multiple
    },
...
if __name__=="__main__":
    exp.run(1, use_restart=True, num_cores=cores, overwrite_data=False, 
            restart_file='/home/lewis/test_time_res/res_from_longrun/res_seasons.tar.gz')
    for i in range(2,72):
