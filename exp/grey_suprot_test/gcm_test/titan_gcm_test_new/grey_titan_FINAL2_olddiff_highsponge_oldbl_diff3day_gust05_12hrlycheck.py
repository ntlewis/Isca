...
expname = lambda om_fact:'TITAN_T21L52_olddiff_highsponge_oldbl_diff3day_gust05_12hrly'
timestep  = 540.#60.#120
...
# sponge params
sponget = 0.5 
spongep = ps * 0.007 / 1500 #1.3e-5 #/ 20.
...
#exp.inputfiles = [os.path.join(base_dir, 'create_ic/titan_col_log_check_newFlux_52H145_ic_T21.nc')]
...
#         'file_name':'INPUT/titan_col_log_check_newFlux_52H145_ic_T21.nc', 
#         'u_name': 'ucomp', 
#         'v_name': 'vcomp', 
#         't_name': 'temp', 
#         'ps_name': 'ps'
...
if __name__=="__main__":
    ...
    #ds = af.open_experiment('titan_col_log_check_newFlux_52H145',50,50,'atmos_monthly.nc',
    ...
    exp.run(1,num_cores=cores, use_restart=True, overwrite_data=False, 
            restart_file='/network/group/aopp/planetary/PLR018_LEWIS_VENUS2/isca_data/'+
                         'TITAN_T21L52_olddiff_highsponge_oldbl_diff3day_gust05/restarts/res1684.tar.gz')
    for i in range(2,25):
