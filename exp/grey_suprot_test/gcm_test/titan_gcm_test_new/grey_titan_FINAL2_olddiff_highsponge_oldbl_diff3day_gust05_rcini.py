...
expname = lambda om_fact:'TITAN_T21L52_olddiff_highsponge_oldbl_diff3day_gust05_rcini'
timestep  = 5.#60.#120
...
# BL params 
gust        = 0.5 
rough_mom   = 5.e-4#5.e-3
rough_moist = 5.e-4#1.e-5
rough_sens  = 5.e-4#1.e-5
background_m = 0.01#5
background_t = 0.01#5
...
exp.inputfiles = [os.path.join(base_dir, 'create_ic/titan_col_log_check_newFlux_52H145_multi_ic_T21lat.nc')]
...
exp.namelist = namelist = Namelist({
    ...
    'ic_from_external_file_nml':{ 
        'file_name':'INPUT/titan_col_log_check_newFlux_52H145_multi_ic_T21lat.nc', 
        'u_name': 'ucomp', 
        'v_name': 'vcomp', 
        't_name': 'temp', 
        'ps_name': 'ps'
