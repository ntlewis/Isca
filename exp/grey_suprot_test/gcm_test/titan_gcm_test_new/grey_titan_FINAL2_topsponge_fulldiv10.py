...
expname = lambda om_fact:'TITAN_T21L52_topsponge_fulldiv10'
timestep  = 540.#60.#120
...
exp.namelist = namelist = Namelist({
    ...
    'spectral_dynamics_nml': {
        ...
        'zmu_sponge_coeff':1./86400. * radius**2. / (fourier*spherical),
        'zmv_sponge_coeff':1./86400. * radius**2. / (fourier*spherical),
...
#         'file_name':'INPUT/titan_col_log_check_newFlux_ic.nc', 
#         'u_name': 'ucomp', 
#         'v_name': 'vcomp', 
#         't_name': 'temp', 
#         'ps_name': 'ps'
...
#     run_exp.namelist['mixed_layer_nml']['neil_ic_file_name'] = 'INPUT/titan_col_log_check_newFlux_ic.nc'
