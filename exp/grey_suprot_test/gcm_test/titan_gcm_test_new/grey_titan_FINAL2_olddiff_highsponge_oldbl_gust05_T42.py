...
expname = lambda om_fact:'TITAN_T42L52_olddiff_highsponge_oldbl_gust05'
timestep  = 540.#60.#120
...
exp.inputfiles = [os.path.join(base_dir, 'create_ic/titan_col_log_check_newFlux_52H145_ic_T42.nc')]
...
exp.namelist = namelist = Namelist({
    ...
    'ic_from_external_file_nml':{ 
        'file_name':'INPUT/titan_col_log_check_newFlux_52H145_ic_T42.nc', 
        'u_name': 'ucomp', 
        'v_name': 'vcomp', 
        't_name': 'temp', 
        'ps_name': 'ps'
