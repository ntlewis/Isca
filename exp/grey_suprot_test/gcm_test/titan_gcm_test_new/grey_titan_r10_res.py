...
expname = lambda om_fact:'TITAN_T21L50_r10_res'
timestep  = 360.#180.#60.#120
...
## RT params 
tau_zero                = .5#.06#.#4.54#4.47 #next change the .9 to a .8
pres_zero               = .3*1e5
...
do_log_sw2 = False
logf = 1./3.
logtau_B  = 0.1053#0.09980#0.09229
logtau_sw_s = 1.6094#1.897
logtau_0 = 81.9678#106#193.7#356.7
logtau_siglev = 0.001446#0.0005761
logtau_pres_zero = ps
...
exp.inputfiles = [os.path.join(base_dir, 'create_ic/titan_col_log_check4_ic.nc')]
...
exp.namelist = namelist = Namelist({
    ...
    'ic_from_external_file_nml':{ 
        'file_name':'INPUT/titan_col_log_check4_ic.nc', 
        'u_name': 'ucomp', 
        'v_name': 'vcomp', 
        't_name': 'temp', 
        'ps_name': 'ps'
...
if __name__=="__main__":
    ...
    run_exp.namelist['mixed_layer_nml']['neil_ic_file_name'] = 'INPUT/titan_col_log_check4_ic.nc'
    run_exp.run(1, use_restart=False, num_cores=cores, overwrite_data=True)
