...
expname = lambda om_fact:'TITAN_T21LLEB_newcfg1em3'
timestep  = 540.#60.#120
...
# BL params 
gust        = 0.5 
rough_mom   = 1.e-3#5.e-4#5.e-3
rough_moist = 1.e-3#5.e-4#1.e-5
rough_sens  = 1.e-3#5.e-4#1.e-5
background_m = 0.01#5
background_t = 0.01#5
...
exp.inputfiles = [os.path.join(base_dir, 'create_ic/titan_col_log_check_newFlux_50H145_leblevs_rstgam_ic_T21.nc')]
...
#         'exponent':3.0,
    ...
    'ic_from_external_file_nml':{ 
        'file_name':'INPUT/titan_col_log_check_newFlux_50H145_leblevs_rstgam_ic_T21.nc', 
        'u_name': 'ucomp', 
        'v_name': 'vcomp', 
        't_name': 'temp', 
        'ps_name': 'ps'
...
if __name__=="__main__":
    ...
    ds = af.open_experiment('titan_col_log_check_newFlux_50H145_leblevs_rstgam',50,50,'atmos_monthly.nc',
