...
expname = lambda om_fact:'TITAN_T21L50_om2'
timestep  = 180.#60.#120
...
del_sol        = 1.#0.9#1.4
omega          = 4.56e-6*2.#(-1*diurnal_period)
radius         = 2.576e6 #/ 20.
ps             = 1.5e5 #*10.#
grav           = 1.35
R_d            = 290. 
...
if __name__=="__main__":
    exp.run(1, use_restart=True, num_cores=cores, overwrite_data=False, 
            restart_file='/network/group/aopp/planetary/PLR018_LEWIS_VENUS2/isca_data/TITAN_T21L50/restarts/res1480.tar.gz')
