...
expname = lambda om_fact:'TITAN_T21L52_olddiff_highsponge_oldbl_ures'
timestep  = 60.#60.#120
...
exp.inputfiles = [os.path.join(base_dir, 'create_ic/titan_col_log_check_newFlux_52H145_icwithu_T21.nc')]
...
exp.namelist = namelist = Namelist({
    ...
    'ic_from_external_file_nml':{ 
        'file_name':'INPUT/titan_col_log_check_newFlux_52H145_icwithu_T21.nc', 
        'u_name': 'ucomp', 
        'v_name': 'vcomp', 
        't_name': 'temp', 
        'ps_name': 'ps'
