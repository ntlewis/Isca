...
exp = Experiment('grey_T42L50_rad1_8_res_test', codebase=cb)

exp.inputfiles = [os.path.join(base_dir,'input/col_1bar_noabs_ic.nc')]
...
exp.namelist = namelist = Namelist({
    ...
    'ic_from_external_file_nml':{ 
        'file_name':'INPUT/col_1bar_noabs_ic.nc', 
        'u_name': 'ucomp', 
        'v_name': 'vcomp', 
        't_name': 'temp', 
        'ps_name': 'ps'
    ...
    'mixed_layer_nml': {
        ...
        'ic_neil_style':True, 
        'neil_ic_file_name': 'INPUT/col_1bar_noabs_ic.nc',
        'evaporation':False,   
