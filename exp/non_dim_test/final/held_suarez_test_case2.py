...
if __name__ == '__main__':
    ...
    exps_dict={}
    n_exp = 6
    exps_dict[0] = {'rad_factor':1, 'omg_factor':1,'dt':900}
    exps_dict[1] = {'rad_factor':2, 'omg_factor':1,'dt':600}
    exps_dict[2] = {'rad_factor':4, 'omg_factor':1,'dt':300}
    exps_dict[3] = {'rad_factor':8, 'omg_factor':1,'dt':150}
    exps_dict[4] = {'rad_factor':8, 'omg_factor':4,'dt':150}
    exps_dict[5] = {'rad_factor':1, 'omg_factor':8,'dt':600}
