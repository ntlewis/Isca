...
if __name__ == '__main__':
    exp.run(1, num_cores=NCORES, use_restart=False, overwrite_data=False)
    for i in range(2, 21):
        exp.run(i, num_cores=NCORES, overwrite_data=False)  # use the restart i-1 by default

    run_exp=exp.derive('hs_omg_1_64_T63')
    run_exp.namelist['hs_forcing_nml']['equilibrium_t_option']='Held_Suarez'
    run_exp.namelist['hs_forcing_nml']['t_zero']=315.
    run_exp.namelist['hs_forcing_nml']['t_strat']=200.
    run_exp.namelist['hs_forcing_nml']['delh']=60.
    run_exp.namelist['hs_forcing_nml']['delv']=10.
    run_exp.namelist['hs_forcing_nml']['eps']=0.
    run_exp.namelist['hs_forcing_nml']['sigma_b']=0.7
    run_exp.namelist['hs_forcing_nml']['ka']=-40.
    run_exp.namelist['hs_forcing_nml']['ks']=-4.
    run_exp.namelist['hs_forcing_nml']['kf']=-1.
    run_exp.namelist['hs_forcing_nml']['do_conserve_energy']=True
    run_exp.namelist['hs_forcing_nml']['sponge']=True
    run_exp.namelist['hs_forcing_nml']['sp_coeff']=-0.5
    run_exp.namelist['hs_forcing_nml']['sigma_sp']=10./1000.
