...
if __name__ == '__main__':
    rads = [23.]
    earth_rad = 6400.e3
    for rad_factor in rads:    
        run_exp = exp.derive('hs_vary_rad_'+str(rad_factor)+'_rescale_dt300_d_coeff_comp_w_rescale')
        run_exp.namelist['constants_nml']['omega'] = 7.2921150e-5 / rad_factor
        run_exp.namelist['hs_forcing_nml']['ka'] = rad_factor * -40.
        run_exp.namelist['hs_forcing_nml']['ks'] = rad_factor * -4.
        run_exp.namelist['hs_forcing_nml']['kf'] = rad_factor * -1.
        run_exp.namelist['spectral_dynamics_nml']['damping_coeff'] = 1.15740741e-4 / rad_factor
