...
exp = Experiment('column_test_exp_remspec_multi', codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'column_nml': {
        ...
        'lat_max': 30, # number of columns in latitude, precise 
    ...
    'column_init_cond_nml': {
        'initial_temperature': 500., # initial atmospheric temperature 
