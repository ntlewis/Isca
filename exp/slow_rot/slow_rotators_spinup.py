...
exp_name = 'omg_1_16_T85_spinup'
exp = Experiment(exp_name, codebase=cb)

#Tell model how to write diagnostics
diag = DiagTable()
diag.add_file('atmos_out', 12, 'hours', time_units='hours')
...
rf = os.path.join(GFDL_DATA,'omg_1_16_T85/restarts/res0001.tar.gz')
#Lets do a run!
if __name__ == '__main__':
    exp.run(1, num_cores=NCORES, restart_file=rf, overwrite_data=False)
    # for i in range(2, 17):
    #     if i == 16:
    #         diag = DiagTable()
