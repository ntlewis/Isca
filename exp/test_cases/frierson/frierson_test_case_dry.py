...
exp = Experiment('frierson_test_experiment_dry', codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'idealized_moist_phys_nml': {
        ...
        'titan_gray':False, 
        'convection_scheme': 'DRYADJ', #Use the simple Betts Miller convection scheme from Frierson
    },
    ...
    'spectral_init_cond_nml': {
        'initial_temperature': 280., # initial atmospheric temperature 
    },
