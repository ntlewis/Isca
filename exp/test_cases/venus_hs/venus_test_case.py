...
exp.inputfiles = ['/home/lewis/research/tools/stuff_for_making_profile/relaxation_profile3.nc']
...
namelist = Namelist({
    ...
    'hs_forcing_nml': {
        ...
        'equilibrium_t_file'   : 'relaxation_profile3',                          # NTL: MAKE THIS FILE                       **
        'venus_model'          : True, 
...
if __name__ == '__main__':
    ...
    for i in range(2, 601): # change here from 601
