...
exp = Experiment('soc_aquaplanet_amip_djf_cont_heating', codebase=cb)
exp.clear_rundir()
...
exp.inputfiles = [os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_1990.nc'),
                  ...
                  os.path.join(GFDL_BASE,'exp/test_cases/socrates_test/input/sst_djf.nc'), 
...
exp.namelist = namelist = Namelist({
	...
	'local_heating_option':'Polar', 
        'local_heating_srfamp':1.0, 
        'local_heating_ywidth':10.0, 
	'local_heating_ycenter':90.0, 
	'local_heating_vert_decay':5.0e3, 
	'local_heating_delta_p0':5.0e4, 
    }, 
    ...
    'mixed_layer_nml': {
        ...
        'sst_file' : 'sst_djf', #Set name of sst input file
...
if __name__=="__main__":
        ...
        exp.run(1, use_restart=True, num_cores=NCORES, overwrite_data=overwrite, 
