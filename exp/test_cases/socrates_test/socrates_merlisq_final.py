...
if __name__=="__main__":
        ...
        #exp = Experiment('soc_aquaplanet_tanlchshaw_merlisq', codebase=cb)
        run_exp = exp.derive('soc_aquaplanet_tls_qflx')
        ...
        run_exp2 = exp.derive('soc_aquaplanet_tls_qflx_mod_hcap')
        ...
        run_exp2.run(1, use_restart=True, num_cores=NCORES, overwrite_data=overwrite, 
                     restart_file='/scratch/ntl203/isca_data/soc_aquaplanet_tls_qflx/restarts/res0030.tar.gz')
        for i in range(2,41):
            if i == 37:
                diag = DiagTable()
                diag.add_file('atmos_6hrly', 6, 'hours', time_units='days')
        ...
        run_exp3 = exp.derive('soc_aquaplanet_tls_qflx_nomod_hcap')
