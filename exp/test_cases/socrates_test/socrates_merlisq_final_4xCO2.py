...
exp = Experiment('soc_aquaplanet_tanlchshaw_merlisq_4xCO2', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        #exp = Experiment('soc_aquaplanet_tanlchshaw_merlisq', codebase=cb)
        run_exp = exp.derive('soc_aquaplanet_tls_qflx_4xCO2')
...
#                 run_exp.diag_table = diag 
        ...
        run_exp2 = exp.derive('soc_aquaplanet_tls_qflx_4xCO2_mod_hcap')
        run_exp2.namelist['mixed_layer_nml']['land_option'] = 'lonlat'
        
        run_exp2.run(1, use_restart=True, num_cores=NCORES, overwrite_data=overwrite, 
                     restart_file='/scratch/ntl203/isca_data/soc_aquaplanet_tls_qflx_4xCO2/restarts/res0030.tar.gz')
        for i in range(2,41):
            if i == 31:
                diag = DiagTable()
                diag.add_file('atmos_6hrly', 6, 'hours', time_units='days')
        ...
        run_exp3 = exp.derive('soc_aquaplanet_tls_qflx_4xCO2_nomod_hcap')
        run_exp3.namelist['mixed_layer_nml']['land_option'] = 'none'
        
        #run_exp3.run(1, use_restart=True, num_cores=NCORES, overwrite_data=True,#overwrite, 
        #             restart_file='/scratch/ntl203/isca_data/soc_aquaplanet_tls_qflx_4xCO2/restarts/res0030.tar.gz')
        for i in range(22,41):
            ...
            run_exp3.run(i, num_cores=NCORES, overwrite_data=True)#overwrite)
