...
exp_name = 'venus_test_daily_inst'               # name experiment 
...
if __name__ == '__main__':
    exp.run(1, num_cores=NCORES, use_restart=True, overwrite_data=True, restart_file='/network/group/aopp/planetary/PLR018_LEWIS_VENUS2/isca_data/venus_test_case/restarts/res0042.tar.gz')
    #for i in range(2, 101): # run for a long time, required to completely spin-up model. 
