...
NCORES = 32
RESOLUTION = 'T42', 80  # T42 horizontal resolution, 25 levels in pressure
...
#inv_omgs =  (2**np.linspace(0,9,10))
inv_omgs = (2**np.linspace(0,7,8))
omgs = 1 / inv_omgs
finish = np.ones(len(omgs), dtype=int) * 97
finish[0:3] = 37 
finish[3] = 73
finish[4] = 121
#finish[-2] = 97
...
if __name__ == '__main__':
    for n, omg in enumerate(omgs):
        exp_name = 'omg_1_'+str(int(inv_omgs[n]))+'_T42L30_FINAL'
