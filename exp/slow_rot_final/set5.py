...
NCORES =2
RESOLUTION = 'T127ax', 80  # T42 horizontal resolution, 25 levels in pressure
...
omgs = 1 / inv_omgs
finish = np.ones(len(omgs), dtype=int) * 25

if __name__ == '__main__':
    for n, omg in enumerate(omgs):
        #if n == 0 or n == 1:
        #    exp_name = 'omg_'+str(int(1/inv_omgs[n]))+'_1_T127L80ax_FINALdaily'
        #else:
        exp_name = 'omg_1_'+str(int(inv_omgs[n]))+'_T127L80ax_FINALdaily'
