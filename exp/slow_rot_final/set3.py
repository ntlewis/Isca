...
inv_omgs =  (2**np.linspace(-2,8,11))
omgs = 1 / inv_omgs
finish = np.ones(len(omgs), dtype=int) * 37

if __name__ == '__main__':
    for n, omg in enumerate(omgs):
        if n == 0 or n == 1:
            exp_name = 'omg_'+str(int(1/inv_omgs[n]))+'_1_T127L80ax_FINAL'
        else:
            exp_name = 'omg_1_'+str(int(inv_omgs[n]))+'_T127L80ax_FINAL'
