...
exp = Experiment('tl_test_experiment_es0_diffout_mo_llcs_baseexp',
                  codebase=cb)
...
omega          = 7.29e-5 /10. #/ 16.   # rotation rate 
...
diag.add_field('dynamics', 'ucompr', time_avg=True)
diag.add_field('dynamics', 'ucompd', time_avg=True)
diag.add_field('dynamics', 'vcompr', time_avg=True)
diag.add_field('dynamics', 'vcompd', time_avg=True)
diag.add_field('dynamics', 'dse_ucomp', time_avg=True)
diag.add_field('dynamics', 'dse_vcomp', time_avg=True)
diag.add_field('dynamics', 'dsefluxdiv', time_avg=True)
diag.add_field('dynamics', 'dse', time_avg=True)
