...
# expname 
expname = 'base_exp_T42L20_om_1_1_a_1_8_ps_1_1_dsol_1_sc_1000_tau43_spg_vk_dt60_dailyfin' # next 9/10
timestep  = 60.#120
restt = '/network/group/aopp/planetary/PLR018_LEWIS_VENUS2/isca_data/base_exp_T42L20_om_1_1_a_1_8_ps_1_1_dsol_1_sc_1000_tau43_spg_vk_dt60/restarts/res0010.tar.gz'
...
if __name__=="__main__":
    exp.run(1, use_restart=True, num_cores=cores, overwrite_data=False, restart_file=restt)
    #for i in range(2,4):#121):
