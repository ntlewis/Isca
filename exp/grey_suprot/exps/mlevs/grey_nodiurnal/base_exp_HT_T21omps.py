...
# expname 
expname = 'base_exp_T21L48_om_1_20_a_1_1_ps_20_1_dsol_1_sc_1000_tau43_dt480' # next 9/10
timestep  = 480.#60.#120
...
#Lets do a run!
restt = '/network/group/aopp/planetary/PLR018_LEWIS_VENUS2/isca_data/base_exp_T21L48_om_1_20_a_1_1_ps_20_1_dsol_1_sc_1000_tau43/restarts/res0020.tar.gz'
if __name__=="__main__":
    exp.run(1, use_restart=True, num_cores=cores, overwrite_data=False, restart_file=restt)
    for i in range(2,201):#121):
