...
# expname 
expname = 'GREY_T42L48_om_1_16_a_1_1_ps_10_1_tau43_noabs_gamma1_diff_tapio_FROMRES' # next 9/10
timestep  = 480.#60.#120
...
# BL params 
gust        = 0.0 
rough_mom   = 5.e-3#3.21e-5
rough_moist = 1.e-5#3.21e-5
rough_sens  = 1.e-5#3.21e-5
...
diag.add_field('atmosphere', 'pbldepth_diffusion', time_avg=True)
...
if __name__=="__main__":
    exp.run(1, use_restart=True, num_cores=cores, overwrite_data=False, restart_file='/home/lewis/1_16_restest/nc_files/new_restart/new_restart.tar.gz')
    for i in range(2,241):#121):
