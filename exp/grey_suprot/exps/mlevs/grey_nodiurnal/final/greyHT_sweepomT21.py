...
# expname 
expname = lambda x: 'GREY_T21L48_om_1_'+str(int(x))+'_a_1_1_ps_1_1_tau43_noabs' # next 9/10
timestep  = 480.#60.#120
...
om_facts = np.array([16.])#, 64.])#, 4., 8., 16., 64.])
ends = [21]
...
if __name__=="__main__":
    ...
    for n, om in enumerate(om_facts): 
