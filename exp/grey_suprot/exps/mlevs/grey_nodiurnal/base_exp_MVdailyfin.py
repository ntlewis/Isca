...
#expname
expname = 'mv_T42L20_om_1_1_a_1_8_ps_1_1_spg_dailyfin'
timestep  = 120#60#60.#120
restt = '/network/group/aopp/planetary/PLR018_LEWIS_VENUS2/isca_data/mv_T42L20_om_1_1_a_1_8_ps_1_1_spg/restarts/res0005.tar.gz'
...
if __name__ == '__main__':
    exp.run(1, num_cores=cores, use_restart=True, overwrite_data=False, restart_file=restt)
    #for i in range(2, 4):
