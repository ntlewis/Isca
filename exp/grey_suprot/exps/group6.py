...
# experiment arrays 
om_array  = np.array([1./16., 1./16., 1./16., 1./16.])
a_array   = np.array([1./2. , 1./2. , 1./2. ,  1./2.])
ps_array  = np.array([20.   , 20.   , 20.   , 20.   ])
abs_array = np.array([1./10., 5./20., 1./2. , 1.    ])

# damping timescale depends on radius 
tsc_array = np.array([9.1   , 9.1   , 9.1   ,  9.1  ])

# names corresponding to experiment arrays 
om_names  =          ['1_16', '1_16', '1_16', '1_16']
a_names   =          ['1_2' , '1_2' , '1_2' , '1_2' ]
ps_names  =          ['20'  , '20'  , '20'  , '20'  ]
abs_names =          ['1_10', '5_20', '1_2' , '1'   ] 
