...
with: ps = 20bar and no sw absorption 
"""
...
# experiment arrays 
om_array  = np.array([1./16., 1./16., 1./16., 1./16., 1./64.])
a_array   = np.array([1.    , 1./2. , 1./4. , 1./8. , 2.    ])
ps_array  = np.array([20.   , 20.   , 20.   , 20.   , 20.   ])  
abs_array = np.array([0.    , 0.    , 0.    , 0.    , 0.    ])

# damping timescale depends on radius 
tsc_array = np.array([12.2  , 9.1   , 6.8   , 5.1   , 16.4  ])

# names corresponding to experiment arrays 
om_names  =          ['1_16', '1_16', '1_16', '1_16', '1_64'] 
a_names   =          ['1_1' , '1_2' , '1_4' , '1_8' , '2_1' ] 
ps_names  =          ['20'  , '20'  , '20'  , '20'  , '20'  ]
abs_names =          ['0'   , '0'   , '0'   , '0'   , '0'   ]
