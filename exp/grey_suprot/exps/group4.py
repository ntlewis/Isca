...
# experiment arrays 
om_array  = np.array([1./4. , 1./4. , 1./4., 1./4., 1./16., 1./16., 1./16., 1./16.])
a_array   = np.array([1./2. , 1./2. , 1./2., 1./2., 1./2. , 1./2. , 1./2. ,  1./2.])
ps_array  = np.array([1.    , 1.    , 1.   , 1.   , 1.    , 1.    , 1.    , 1.    ])
abs_array = np.array([1./10., 5./20., 1./2., 1.   , 1./10., 5./20., 1./2. , 1.    ])

# damping timescale depends on radius 
tsc_array = np.array([9.1   , 9.1   , 9.1  , 9.1  , 9.1   , 9.1   , 9.1   ,  9.1  ])

# names corresponding to experiment arrays 
om_names  =          ['1_4' , '1_4' , '1_4', '1_4', '1_16', '1_16', '1_16', '1_16']
a_names   =          ['1_2' , '1_2' , '1_2', '1_2', '1_2' , '1_2' , '1_2' , '1_2' ]
ps_names  =          ['1'   , '1'   , '1'  , '1'  , '1'   , '1'   , '1'   , '1'   ]
abs_names =          ['1_10', '5_20', '1_2', '1'  , '1_10', '5_20', '1_2' , '1'   ] 
...
if __name__=="__main__":
    ...
    for n, om in enumerate(om_array): 
        # derive experiment 
        run_exp = exp.derive('grey_T42L50_om_'+om_names[n]+'_a_'+a_names[n]+'_ps_'+ps_names[n]+'bar_abs_'+abs_names[n]+'frac')
