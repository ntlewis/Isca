...
insolation: perp_eq (Titan params)
...
exp = Experiment('grey_T31HT_perpeqtitan_om_1_16_a_4_10_ps_1_5bar_titanabs_diffsponge_nc',
                  codebase=cb)
...
# planetary constants 
ps             = 150000.                      # surface pressure

grav           = 1.35                         # acceleration due to gravity 

omega          = 7.2921150e-5 / 16.           # rotation rate 

radius         = 6.371e6 * 0.4                # radius (m)

R_d            = 290.                         # gas constant for dry air 
...
diag = DiagTable()
diag.add_file('atmos_monthly', 933120000.0/12., 'seconds', time_units='seconds')
...
exp.namelist = Namelist({
    ...
    'damping_driver_nml': {
        ...
        'sponge_pbottom':  p_sponge,           #Bottom of the model's sponge down to 50Pa (units are Pa)
