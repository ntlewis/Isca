...
exp = Experiment('grey_T3140_p2earth_om_1_1_a_1_1_ps_1bar_noabs_raysponge',
                  codebase=cb)
...
tau_rc                  = tau_zero #(2.882 / 4.324) * tau_zero
pres_rc                 = ps #(122453 / 150000) * ps
linear_tau              = 0.25
...
if level_type == 'low_top': 
    ...
    p_sponge            = ps / 2000.
elif level_type == 'neil_top': 
    level_option        = 'hybrid'
    num_levels          = 40 
    level_exponent      = 7.0 
    level_surf_res      = 0.5 
    level_scale_heights = 8.0
    p_sponge            = ps * (2.5/1000.)
    t_ray               = 1.
...
exp.namelist = Namelist({
    ...
    'damping_driver_nml': {
        'do_rayleigh': True,
        'trayfric': -1. * t_ray,              # neg. value: time in *days*
