...
insolation: seasonal + titan sc
optical depth: generic + abs (titan vals)
...
exp = Experiment('grey_T31HT_seasonal_om_1_16_a_4_10_ps_1_45bar_abs_3_7frac_g_1_35_sc13',
                  codebase=cb)
...
# planetary constants 
ps             = 145000.                      # surface pressure

grav           = 1.35                         # acceleration due to gravity 

omega          = 7.29e-5 / 16.                # rotation rate 

radius         = 6.371e6 * 0.4                # radius (m)

R_d            = 290.                         # gas constant for dry air !!! 290 for titan

cp             = 1005.                        # specific heat capacity 
                                              # at constant pressure 

# convection constants 
dt_conv        = 3600.                   # timescale for dry convection !!! shorter mimicing moist convection 

gamma_conv     = 0.52                          # lapse rate for dry convection !!!!TITAN VALUE
...
solar_constant = 3.6 * 4.                     # solar constant 

albedo         = 0.27                         # bond albedo 



tau_lw_s       = 3./2. * 3. * 1.25            # longwave optical depth (scat)
...
sw_window_frac = 1. - 4./7.                 # shortwave window fraction 
...
diag = DiagTable()
diag.add_file('atmos_monthly', 900, 'days', time_units='days')
...
exp.namelist = Namelist({
    ...
    'two_stream_scatter_rad_nml': {
        ...
        # remove diurnal cycle by averaging over titan day 
        'use_time_average_coszen':True, 
        'dt_rad_avg': 1381066.61, 
        'equinox_day':0.0 # equinox at beginning of simulation 
    },
