...
# experiment arrays 
om_array  = np.array([1./4., 1./4., 1./4., 1./4., 1./1.])
a_array   = np.array([1.   , 1./2., 1./4., 1./8., 1./8.])
ps_array  = np.array([20.  , 20.  , 20.  , 20.  , 20.  ])  
abs_array = np.array([0.   , 0.   , 0.   , 0.   , 0.   ])

# damping timescale depends on radius 
tsc_array = np.array([12.2 , 9.1  , 6.8  , 5.1  , 5.1  ])

# names corresponding to experiment arrays 
om_names  =          ['1_4', '1_4', '1_4', '1_4', '1_1'] 
a_names   =          ['1_1', '1_2', '1_4', '1_8', '1_8'] 
