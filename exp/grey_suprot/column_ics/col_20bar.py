...
exp = Experiment('col_20bar', codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'column_init_cond_nml': {
        ...
        'surface_wind': 5.#5. # as described above 
    },
...
sw_window_frac_array = 1. - np.array([0.0,1./10.,2.5/10.,1./2.,1.]) 
names_array = ['0','1_10','5_20','1_2','1']

#Lets do a run!
if __name__=="__main__":
    for n, sw_window_frac in enumerate(sw_window_frac_array):
        run_exp = exp.derive('col_20bar_frac'+names_array[n])
