...
exp_name = 'venus_hs_T85'               # name experiment 
...
exp.inputfiles = ['/home/lewis/research/misc/input/venus_relaxation_profile.nc'] # temporary change whilst developing column model. 
...
if __name__ == '__main__':
    ...
    for i in range(2, 1171): # run for a long time, required to completely spin-up model. 
