...
if __name__ == '__main__':
    ...
    for n, om in enumerate(oms):
        omega_exp = omega_e / om
        #step_exp = steps[n]
        run_exp = exp.derive('F_tl_1_1rad_'+names[n]+'_1_1tau_rad')
        ...
        for i in range(2, 31):
            ...
            run_exp.run(i, num_cores=NCORES, overwrite_data=True)  # use the restart i-1 by default
