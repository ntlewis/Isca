...
omega  = 7.29e-5/8.# /8.#/16.#(32.*np.sqrt(2))#4. #$#/ 10. 
...
exp_name = 'tl_1_1rad_1_8om_1_1tau_rad_diff10_dt64'#'tl_jamie_test_1rad_1_8om_25_dt64_tauchange1'#_T170L12'
...
namelist = Namelist({
    ...
    'hs_forcing_nml': {
        ...
        'ka':   -20.,#*32*np.sqrt(2),      # Constant Newtonian cooling timescale (default 40 days)
        'ks':    -5.,#*32*np.sqrt(2),      # Boundary layer dependent cooling timescale (default 4 days)
