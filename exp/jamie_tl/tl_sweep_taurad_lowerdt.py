...
om = 4. 
rad = 4.
names = ['1_1tau']#,'2_1tau','1_1tau']#,'1_2tau','1_4tau']
taus  = np.array([1.])#,2.,1.])#,0.5,0.25])
steps = np.array([1200.])#,32.,32.])#,32.,32.])#32.,32.,32.,64.,128.,256.,512.,512.])
...
if __name__ == '__main__':
    ...
    for n, tau in enumerate(taus):
        ...
        ks_exp = -5. * tau 
        step_exp = steps[n]
        run_exp = exp.derive('tl_4_1rad_'+'1_4om_'+names[n]+'_rad_diff10_origini')
        ...
        for i in range(2, 31):
            ...
            run_exp.run(i, num_cores=NCORES, overwrite_data=True)  # use the 
