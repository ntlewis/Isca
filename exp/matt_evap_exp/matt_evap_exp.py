...
exp = Experiment('matt_evap_exp', codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'idealized_moist_phys_nml': {
        ...
        'land_option':'input', # NTL: Use land mask from input file
        'land_file_name': 'INPUT/land.nc', # NTL: tell model where to find input file 
        'land_roughness_prefactor': 1.0, # NTL: Set 'land' to have SAME roughness as the ocean 
        'bucket':False, # NTL: Run without bucked 
    },
    ...
    'surface_flux_nml': {
        ...
        'do_simple': True,
        'old_dtaudv': True, 
        'land_humidity_prefactor': 1.0, # NTL: \alpha in Vallis et al. (2018)
        'land_evap_prefactor': 0.5 # \beta in Vallis et al. (2018)   (I think!)
    },
    ...
    'mixed_layer_nml': {
        ...
        'land_h_capacity_prefactor': 1.0, # NTL: Set 'land' to have SAME heat capacity as the ocean 
        'albedo_value': 0.25, #Ocean albedo value
        'land_albedo_prefactor' : 1.0, # NTL: Set 'land' to have SAME albedo as the ocean 
