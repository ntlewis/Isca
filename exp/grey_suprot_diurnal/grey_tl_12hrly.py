...
# expname 
expname = 'GREY_T42L30fr_TL_om_1_40_a_1_1_ps_1_1_12hrly' # next 9/10
timestep  = 720.#60.#120
...
if __name__=="__main__":
    exp.run(1, use_restart=True, num_cores=cores, overwrite_data=False, 
            restart_file='/network/group/aopp/planetary/PLR018_LEWIS_VENUS2/isca_data/GREY_T42L30fr_TL_om_1_40_a_1_1_ps_1_1/restarts/res0010.tar.gz')
