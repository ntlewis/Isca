...
expname = lambda n:'GREY_T42L30fr_TL_om_1_10_a_1_1_ps_1_1_TJ001_n'+str(int(n))#_12hrly'
timestep  = 360.#60.#120
...
if __name__=="__main__":
    ns = np.array([1.,2.])#2.,4.,6.,8.,10.,20.,40.,60.,80.,100.,200.])
    for n in ns:
        expname_use = expname(n)
        run_exp = exp.derive(expname_use)#+'_12hrly')
        run_exp.namelist['titan_gray_rad_nml']['nonlin_tau_exponent'] = n
