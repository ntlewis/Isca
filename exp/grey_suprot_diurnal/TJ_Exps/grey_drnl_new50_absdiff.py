...
expname = lambda om_fact:'GREY_T42L50new_Drnl_om_1_'+str(int(om_fact))+'_a_1_1_ps_1_1_TJ001_n43abs_frac1_tau1'
timestep  = 120.#60.#120
...
sw_k1                   = 1.#/(0.1**(4./3.))#51.8 #35.168 #0.0 #
