...
expname = lambda om_fact:'GREY_T42L30fr_TL_om_1_'+str(int(om_fact))+'_a_1_1_ps_1_1_TJ001'#_12hrly'
timestep  = 540.#60.#120
...
if __name__=="__main__":
    om_facts = np.array([2.,4.,6.,8.,10.,20.,40.,60.,80.,100.,200.])
    for om_fact in om_facts:
        ...
        run_exp.run(1, use_restart=True, num_cores=cores, overwrite_data=False, restart_file='/network/group/aopp/planetary/PLR018_LEWIS_VENUS2/isca_data/'+expname_use+'/restarts/res0010.tar.gz')
