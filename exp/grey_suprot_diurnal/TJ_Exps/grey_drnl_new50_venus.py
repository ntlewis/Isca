...
expname = lambda om_fact:'GREY_T21L60new_Drnl_om_1_'+str(int(om_fact))+'_a_1_1_ps_100_1_TJ001_venus'
timestep  = 360.#60.#120

# planet params 
diurnal_period = -100.
solar_constant = 160.*4
del_sol        = 1.#0.9#1.4
...
sw_k1                   = 0.0973 #51.8 #35.168 #0.0 #
sw_k2                   = 0.000345 #0.071 #0.0599 # #
...
if __name__=="__main__":
    om_facts = np.array([100.])#2.,4.,6.,8.,10.,20.,40.,60.,80.,100.,200.])
    for om_fact in om_facts:
        ...
        #restart_file='/network/group/aopp/planetary/PLR018_LEWIS_VENUS2/isca_data/'+expname_use+'/restarts/res0010.tar.gz')
        for i in range(100,1001):#121):
