...
expname = lambda om_fact:'GREY_T42L40fr6_TL_om_1_'+str(int(om_fact))+'_a_1_1_ps_1_1_TJ001_n1_abs100hPahalffrac'#_12hrly'
timestep  = 360.#60.#120
...
sw_k1                   = 1/(0.1**(1.))#(4./3.))#0.0 #51.8 #35.168 #0.0 #
...
if __name__=="__main__":
    om_facts = np.array([10.])#2.,4.,6.,8.,10.,20.,40.,60.,80.,100.,200.])
